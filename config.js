...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "25670280712236";
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "256708328694";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "sh!t is happenin" , // ```💀```"),
